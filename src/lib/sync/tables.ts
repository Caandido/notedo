...
export type TableDesc = {
  local: "subjects" | "topics" | "sessions" | "goals" | "reviews" | "flashcards" | "events" | "grades" | "mindmaps" | "activities" | "boards" | "cards" | "notes" | "canvases";
  remote: string;
  chunk: number;
...
export const TABLE_DESCRIPTORS: TableDesc[] = [
  {
    ...
    fields: {
      ...
      gradeTarget: { col: "grade_target" },
      gradeTotalWeight: { col: "grade_total_weight" },
      gradeGoals: { col: "grade_goals", json: true },
      createdAt: CREATED,
      updatedAt: UPDATED,
    },
  },
  ...
  },
  {
    ...
    fields: {
      ...
      userId: UID,
      subjectId: { col: "subject_id" },
      subjectIds: { col: "subject_ids", json: true },
